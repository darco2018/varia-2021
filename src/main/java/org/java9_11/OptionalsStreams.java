...
public class OptionalsStreams {
    ...
    public static void main(String[] args) {
        ...
        Optional.ofNullable(null)
                .or(() -> Optional.of("fallback")) // if no value present, returns Optional produced by function
                .get();                           // fallback
        ...
        ////  dropWhile & takeWhile - especially useful when stream is ordered?!
...
//---------------Predicate.not(____::___) A static not method has been added to the Predicate interface.
// We can use it to negate an
